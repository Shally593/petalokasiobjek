...
<body>
    ...
    <script>
        ...
        /* Draw Event : event nya created, bisa untuk edit atau delete
        sesuai dengan ketentuan event draw yang dapat digunakan */
        ...
        var line = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                ...
                layer.on({
                    ...
                    mouseover: function(e) {
                        line.bindTooltip(feature.properties.nama + "<br>" + feature.properties.panjang);
                    },
                });
            },
        });
        ...
        var polygon = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                ...
                "Area: " + feature.properties.area_m + " m^2" + "<br>" + "Area: " + feature.properties.area_ha + " ha^2" + "<br>" + "Area: " + feature.properties.area_km + " km^2";
                layer.on({
                    click: function(e) {
                        polygon.bindPopup(popupContent);
                    },
                    mouseover: function(e) {
                        polygon.bindTooltip(feature.properties.nama + "<br>" + feature.properties.area_m + "<br>" + feature.properties.area_ha + "<br>" + feature.properties.area_km);
                    },
                });
            },
        });
