...
<head>
    ...
    <!--Routing Machine-->
    <link rel="stylesheet" href="<?= base_url('assets/plugins/leaflet-routing-machine-3.2.12/dist/leaflet-routing-machine.css') ?>">
...
<body>
    ...
    <!-- <script src="<?= base_url('assets/plugins/leaflet-routing-machine-3.2.12/dist/leaflet-routing-machine.js') ?>"></script> -->
    <script src="<?= base_url('assets/plugins/leaflet-routing-machine-3.2.12/dist/leaflet-routing-machine.min.js') ?>"></script>
    <script src="<?= base_url('assets/plugins/leaflet-routing-machine-3.2.12/examples/Control.Geocodes.js') ?>"></script>
    ...
    <script>
        ...
        $.getJSON("<?= base_url('copeta') ?>", function(data) {
            point.addData(data);
            map.addLayer(point);
        });
    </script>
