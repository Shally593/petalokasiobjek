    ...
    <div class="container my-3">
        ...
        <div class="card">
            <div class="card-header">
                <H2><i class="fa-regular fa-calendar-plus"></i> Edit Data Lokasi Library Cafe</H2>
            </div>
            <div class="card-body">
                <form action="<?= base_url('libcaffe/simpan_edit_dataa') . '/' . $dataobjek['id'] ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="mb-3">
